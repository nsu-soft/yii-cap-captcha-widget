...
[![Status](https://img.shields.io/badge/stable-1.0.2-blue.svg)](https://packagist.org/packages/nsu-soft/yii-cap-captcha-widget)
...
| `cssVars` | `array` | `[]` | Переменные CSS, которые Вы хотите переопределить. Смотрите все доступные переменные в `CapWidget::DEFAULT_CSS_VARS` |
